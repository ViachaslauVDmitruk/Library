...
describe('Sprint 7', () => {
	...
	describe('Profile functions tests', () => {
		...
		const formTest = (width, heigth) => {
			...
			cy.get('[data-test-id=profile-form] input[name=login]').clear().blur().wait(1);
			...
			cy.get('[data-test-id=profile-form] input[name=firstName]').clear().blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=lastName]').clear().blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=password]').clear().blur().wait(1);
			cy.get('[data-test-id=hint]')
				.should('be.visible')
				.eq(1)
				.should('be.visible')
				...
				.should('have.css', 'font-size', '12px')
				.should('have.css', 'letter-spacing', '0.2px');
			cy.get('[data-test-id=profile-form] input[name=phone]').clear().blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=email]').clear().blur().wait(1);
			cy.get('[data-test-id=hint]')
				.should('be.visible')
				.eq(5)
				.should('be.visible')
			...
			cy.get('[data-test-id=hint]')
				...
				.should('have.css', 'letter-spacing', '0.2px')
				.should('have.css', 'color', 'rgb(244, 44, 79)');
			cy.get('[data-test-id=profile-form] input[name=phone]').clear().type('+').blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=phone]').should('have.value', '+375 (xx) xxx-xx-xx');
			cy.get('[data-test-id=profile-form] input[name=phone]').clear().type('+335353').blur().wait(1);
			...
			cy.get('[data-test-id=profile-form] input[name=login]')
				...
				.blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=firstName]').clear().type('Igor').blur().wait(1);
			cy.get('[data-test-id=profile-form] input[name=lastName]')
				.clear()
				.type('Shidlovsky')
				.blur().wait(1);
