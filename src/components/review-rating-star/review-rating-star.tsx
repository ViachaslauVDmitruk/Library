    ...
    <div className={styles.ratingStar}>
      <div className={styles.rowStars} data-test-id='rating'>
        ...
        <label htmlFor='1' className={styles.starRatingLabel} data-test-id='star'>
          <Star id={watch('rating') > 0 ? 'star-active' : ''} stylePass={watch('rating') > 0 ? styles.colorStar : ''} />
        </label>
        ...
        <label htmlFor='2' className={styles.starRatingLabel} data-test-id='star'>
          <Star id={watch('rating') > 1 ? 'star-active' : ''} stylePass={watch('rating') > 1 ? styles.colorStar : ''} />
        </label>
        ...
        <label htmlFor='3' className={styles.starRatingLabel} data-test-id='star'>
          <Star id={watch('rating') > 2 ? 'star-active' : ''} stylePass={watch('rating') > 3 ? styles.colorStar : ''} />
        </label>
        ...
        <label htmlFor='4' className={styles.starRatingLabel} data-test-id='star'>
          <Star id={watch('rating') > 3 ? 'star-active' : ''} stylePass={watch('rating') > 3 ? styles.colorStar : ''} />
        </label>
        ...
        <label htmlFor='5' className={styles.starRatingLabel} data-test-id='star'>
          <Star id={watch('rating') > 4 ? 'star-active' : ''} stylePass={watch('rating') > 4 ? styles.colorStar : ''} />
        </label>
      </div>
    </div>
  );
